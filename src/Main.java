    ...
    public static void main(String[] args) {
        ...
        switch (C4) {
            ...
            case 3:
                ...
                Stream<Creature> creatureStream = Stream.generate(Creature::generateRandomCreature);
                Gatherer<Creature> creatureGatherer = new Gatherer<>(creatureStream, fieldValueToFilter, N);
                List<Creature> creatures = creatureGatherer.gather(500, Creature::getType);
                creatures = filterByParameterB(creatures, Creature::getYearsSinceFirstAppearance, minB, maxB);
                groupAndPrintResults(creatures, Creature::getType);
